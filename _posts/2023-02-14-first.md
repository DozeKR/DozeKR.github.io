...
어린 시절 우연히 접한 RPGXP 프로그램을 통해 게임개발자의 꿈을 향해 발을 딛고 있습니다.
강원대학교 컴퓨터공학과를 수료하고, 현재는 유니티를 활용해 게임을 개발하고 있습니다.
항상 프로젝트에 팀장을 맡아 적극적으로 참여하며 책임감을 가지고 역할에 최선을 다하는 개발자입니다.
...
현재 깃허브와 깃허브블로그를 운영중입니다.
 ...
 [깃허브블로그](https://dozekr.github.io/){: .btn .btn--info}
...
|.etc||
|---|---|
|MSoffice|MOS Excell, MOS Access 자격증을 보유하고 있으며, 프로젝트 발표 PPT를 전담하여 맡아 제작하여 발표한 경험이 많습니다.|
